                  ...
                  return (
                    ...
                    >
                      <td>
                        ...
                        <input
                          type="checkbox"
                          className="h-4 w-4 cursor-pointer rounded border-sig-300 accent-sig-700"
                          {...form.register(`selections.${index}.included`)}
                        />
                      </td>
                      <td className="tabular font-semibold text-sig-900">
                        {device.tagNumber}
                      </td>
                      <td>{device.description}</td>
                      <td>
                        <span className="inline-flex rounded-md bg-sig-100 px-2 py-0.5 text-xs font-semibold text-sig-800">
                          {device.deviceType}
                        </span>
                      </td>
